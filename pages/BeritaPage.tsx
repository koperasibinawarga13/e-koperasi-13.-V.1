            ...
            <header className="bg-primary shadow-md sticky top-0 z-10">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-white leading-tight">KOPERASI Bina WARGA</h1>
                            <p className="text-sm text-blue-200 leading-tight">SMP Negeri 13 Tasikmalaya</p>
                        </div>
                    </div>
