            ...
            <header className="bg-primary shadow-md sticky top-0 z-10">
                <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        <LogoKoperasi className="w-10 h-10 bg-white rounded-full p-1 flex-shrink-0" />
                        <div>
                            <h1 className="text-xl font-bold text-white leading-tight">Berita & Program Koperasi</h1>
                            <p className="text-sm text-blue-200 leading-tight">Informasi terbaru tentang produk dan program-program Koperasi.</p>
                        </div>
                    </div>
