...
const Section: React.FC<{ title: string, children: React.ReactNode }> = ({ title, children }) => (
    <div className="mt-8">
        <h3 className="text-lg font-medium leading-6 text-dark pb-2 mb-4">{title}</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <div className="mt-1 min-h-[20px] text-sm font-semibold">
                                    ...
                                    {namaAnggota && (<span className={namaAnggota.includes('ditemukan') || namaAnggota.includes('Gagal') ? 'text-red-500' : 'text-green-500'}>{namaAnggota}</span>)}
                                </div>
                            </div>
                            <div>
